...
public class Soldier {
    ...
    public Soldier(String name, String kingdom, int row, int column) {
        this(name, row, column);
        this.kingdom = kingdom;
    }

    public Soldier(String name, int row, int column) {
        this.name = name;
        this.attackLevel = random(MIN_LEVEL, MAX_LEVEL);
        this.defenseLevel = random(MIN_LEVEL, MAX_LEVEL);
        this.healthLevel = random(MIN_LEVEL, MAX_LEVEL);
        this.currentHealth = healthLevel;
        this.row = row;
        this.column = column;
    }

    public Soldier(String name, String kingdom, int attack, int defense, int health, int row, int column) {
        this.name = name;
    ...
    public Soldier(Soldier soldier) {
        ...
        this.attackLevel = soldier.attackLevel;
        this.defenseLevel = soldier.defenseLevel;
        this.healthLevel = soldier.healthLevel;
        this.currentHealth = soldier.currentHealth;
        this.speed = soldier.speed;
        this.attitude = soldier.attitude;
        this.isAlive = soldier.isAlive;
        this.row = soldier.row;
        this.column = soldier.column;
